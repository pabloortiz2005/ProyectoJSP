...
<body>
    <div class="contenedor">
        ...
        <form action="ListarTareas" method="GET">
        ...
        <table border="1">
            ...
            <tr>
                ...
                <td>
                    <a href="eliminarTarea?id_tarea=<%= tarea.getId() %>">Eliminar</a>
                </td>
            </tr>
            <%
                    }
        ...
        <br>
        <a href="agregarTarea.jsp?id_proyecto=<%= request.getParameter("id_proyecto") %>">Agregar Nueva Tarea</a>
        <br>
        <a href="listarProyectos.jsp">Volver a Proyectos</a>
    </div>
</body>
</html>
